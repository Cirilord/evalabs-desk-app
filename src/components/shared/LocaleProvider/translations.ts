...
[Write the specific behavior, rules, and edge cases you expect from the script here.]`,
    ...
    'create.editDescription': 'Update the script and inputs of this automation.',
    ...
    'create.scriptHint':
      'Define main() when there are no inputs, or main(inputs) otherwise. Use print for logs; input() is not supported.',
    ...
    'settings.builtInCodeEditor': 'Built-in editor',
    ...
    'runs.editScriptDescription': 'Update the Python code used by this automation.',
    'runs.error': 'Error',
    'runs.inputs': 'Inputs',
    'runs.logs': 'Logs',
    'runs.noLogs': 'No logs.',
    ...
    'runs.savingScript': 'Saving script...',
    'runs.runs': 'Runs',
    'runs.runner': 'Runner',
...
[Escreva aqui o comportamento, as regras e os casos de borda esperados para o script.]`,
    ...
    'settings.builtInCodeEditor': 'Editor integrado',
    ...
    'runs.editScriptDescription': 'Atualize o código Python usado por esta automação.',
    'runs.error': 'Erro',
    ...
    'runs.savingScript': 'Salvando script...',
    'runs.runs': 'Execuções',
